...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" isELIgnored="false"%>
	...
	<c:url value="/annealing_over_report/xls" var="downloadXls" />
	<c:url value="/annealing_over_report/pdf" var="downloadPdf" />
	<c:url value="/annealing_over_report/csv" var="downloadCsv" />
	...
	$('#fromDate').change(function() {
		...
		$("#showreport").click(
			...
			$("#loadingImageHtmlReport").show();
			   ...
			   $.ajax({
				type : "POST",
				url : "annealing_over_report/html?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val(),
		...
		var url = "annealing_over_report/pdf?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val();
		...
		var url = "annealing_over_report/xls?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val();
		try { var child = window.open(url); child.focus(); } catch (e) { }
		 });	
		...
		var url = "annealing_over_report/csv?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val();
		try {
...
<body>
	<div class="header">Annealing Oven Report</div>
	<div class='accordion'>
...
<div class="headerbg">
	...
	<div style="float: right; margin-top:-48px; width: 400px; " >
			<ul class="icon">
