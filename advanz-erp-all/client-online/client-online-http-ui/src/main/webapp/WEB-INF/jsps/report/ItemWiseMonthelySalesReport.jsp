		...
		$("#showreport").click(
			...
			$("#loadingImageHtmlReport").show();
			   ...
			   $.ajax({
				...
				type : "POST",
				url : "item_wise_msales_report/html?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val(),
			    success: function(data) {
				   ...
				   return false; 
					...
					$("#downloadPdf").click( function() {
						...
						var url = "item_wise_msales_report/pdf?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val();
					...
					$("#downloadXls").click( function() {
						...
						var url = "item_wise_msales_report/xls?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val();
					 		try { var child = window.open(url); child.focus(); } catch (e) { }
					 });	
					...
					$("#downloadCsv").click( function() {
						...
						var url = "item_wise_msales_report/csv?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val();
					 		try {
...
<body>
<div class="header">Item Wise Monthly Sales Report</div>
<div class='accordion'>
...
<div class="headerbg">
		 ...
		 <table style="width: 550px;">
			...
			<td width="135"><form:input path="itemwisesalesReportFrom.fromDate"  id="fromDate" style="width:50pxl;"
							 size="16" readonly="true"/>
							</td>
			
			<td width="35" nowrap="nowrap">To Date:<span style="color: red;">*</span></td>
			<td width="135"><form:input path="itemwisesalesReportFrom.toDate"  id="toDate"
							 size="16" readonly="true"/>
							</td>
			</tr>
			<tr>
