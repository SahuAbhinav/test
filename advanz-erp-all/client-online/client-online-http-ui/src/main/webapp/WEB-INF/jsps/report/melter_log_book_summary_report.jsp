...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" isELIgnored="false"%>
	...
	<c:url value="/melter_log_book_summary_report/xls" var="downloadXls" />
	<c:url value="/melter_log_book_summary_report/pdf" var="downloadPdf" />
	<c:url value="/melter_log_book_summary_report/csv" var="downloadCsv" />
	...
	$('#fromDate').change(function() {
		...
		$("#showreport").click(
			...
			$("#loadingImageHtmlReport").show();
			   ...
			   $.ajax({
				type : "POST",
				url : "melter_log_book_summary_report/html?"+ "fromDate=" +  $("#fromDate").val(),
		...
		var url = "melter_log_book_summary_report/pdf?"+ "fromDate=" +  $("#fromDate").val();
		...
		var url = "melter_log_book_summary_report/xls?"+ "fromDate=" +  $("#fromDate").val();
		try { var child = window.open(url); child.focus(); } catch (e) { }
		 });	
		...
		var url = "melter_log_book_summary_report/csv?"+ "fromDate=" +  $("#fromDate").val();
		try {
...
<body>
	<div class="header">Melter Log Book Summary Report</div>
	<div class='accordion'>
...
<div class="headerbg">
	...
	<div style="float: right; margin-top:-48px; width: 500px; " >
			<ul class="icon">
