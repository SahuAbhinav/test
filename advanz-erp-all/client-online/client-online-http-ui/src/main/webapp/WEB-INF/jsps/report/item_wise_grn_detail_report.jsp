...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<c:url value="/item_wise_grn_detail_report/xls" var="downloadXls" />
	<c:url value="/item_wise_grn_detail_report/pdf" var="downloadPdf" />
	<c:url value="/item_wise_grn_detail_report/csv" var="downloadCsv" />
...
<script>
	...
	$(document).ready(	function() {
			...
			else
		{
			$.ajax({
			type : "POST",
			url : "get_category_group_flag_name?itemGroupFlagName=" +  $("#itemGroupName").val().replace('&','%26'),
			 success: function(data) {
	      ...
	      for (var i = 0; i< data.result.length; i++) {
			...
			$.ajax({
			type : "POST",
			url : "get_item_by_ItemGroupflagName?itemGroupflagName=" +  $("#itemGroupName").val().replace('&','%26'),
			 success: function(data) {
		...
		$("#showreport").click(
			...
			$("#loadingImageHtmlReport").show();
			   ...
			   $.ajax({
				type : "POST",
				url : "item_wise_grn_detail_report/html?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemGroupName=" +$("#itemGroupName").val().replace('&','%26')+ "&itemName=" +$("#itemName").val().replace('&','%26')+"&approvedStatus="+$("#approvedStatus").val()+"&supplierName="+$("#supplierName").val().replace('&','%26')+"&itemcategory="+$("#itemCategoryName").val()+"&activeStatus="+$("#activeStatus").val(),
			    success: function(data) {
				   ...
				   return false; 
					...
					$("#downloadPdf").click( function() {
						...
						var url = "item_wise_grn_detail_report/pdf?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemGroupName=" +$("#itemGroupName").val().replace('&','%26')+ "&itemName=" +$("#itemName").val().replace('&','%26')+"&approvedStatus="+$("#approvedStatus").val()+"&supplierName="+$("#supplierName").val().replace('&','%26')+"&itemcategory="+$("#itemCategoryName").val()+"&activeStatus="+$("#activeStatus").val();
					...
					$("#downloadXls").click( function() {
						...
						var url = "item_wise_grn_detail_report/xls?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemGroupName=" +$("#itemGroupName").val().replace('&','%26')+ "&itemName=" +$("#itemName").val().replace('&','%26')+"&approvedStatus="+$("#approvedStatus").val()+"&supplierName="+$("#supplierName").val().replace('&','%26')+"&itemcategory="+$("#itemCategoryName").val()+"&activeStatus="+$("#activeStatus").val();
					 		try { var child = window.open(url); child.focus(); } catch (e) { }
					 });	
					...
					$("#downloadCsv").click( function() {
						...
						var url = "item_wise_grn_detail_report/csv?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemGroupName=" +$("#itemGroupName").val().replace('&','%26')+ "&itemName=" +$("#itemName").val().replace('&','%26')+"&approvedStatus="+$("#approvedStatus").val()+"&supplierName="+$("#supplierName").val().replace('&','%26')+"&itemcategory="+$("#itemCategoryName").val()+"&activeStatus="+$("#activeStatus").val();
					 		try {
...
<body>
<div class="header">Item wise grn Detail Report</div>
<div class='accordion'>
...
<div class="headerbg">
		 ...
		 <table style="width: 550px; float:left;">
			...
			<td width="135"><form:input path="itemReportFrom.fromDate"  id="fromDate" style="width:50pxl;"
							 size="16" readonly="true"/>
							</td>
			<td width="35" nowrap="nowrap">To Date:</td>
			<td width="135"><form:input path="itemReportFrom.fromDate"  id="toDate"
							 size="16" readonly="true"/>
							</td></tr>
							<tr>
			...
			<td width="135"><form:select path="itemReportFrom.itemGroupName"  id="itemGroupName"  >
		...
		<form:select  path="itemReportFrom.itemCategory" id="itemCategoryName" style="width:120px;" >
			...
			<td width="135"><form:select path="itemReportFrom.itemName"  id="itemName"  >
				<form:option value="All" selected="selected">All</form:option>
			...
			<td width="135"><form:select path="itemReportFrom.approvedStatus"  id="approvedStatus" >
				<form:option value="All" selected="selected">All</form:option>
				<form:option value="Approved" >Approved</form:option>
				<form:option value="Inprocess" >Inprocess</form:option>
				
			</form:select></td>
	         <td width="35" nowrap="nowrap">Supplier Name:</td>
			<td>
			<form:select path="itemReportFrom.supplierName"  id="supplierName"  >
				<form:option value="All" selected="selected">All</form:option>
