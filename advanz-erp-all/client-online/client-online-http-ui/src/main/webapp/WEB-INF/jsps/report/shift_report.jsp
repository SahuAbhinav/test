	...
	$('#fromDate').change(function() {
		...
		$("#showreport").click(
			...
			$("#loadingImageHtmlReport").show();
			   ...
			   $.ajax({
				type : "POST",
				url : "shift_report_report/html?"+ "fromDate=" +  $("#fromDate").val()+ "&shiftName=" +  $("#shiftId").val()+"&toDate="+$("#toDate").val(),
		...
		var url = "shift_report_report/pdf?"+ "fromDate=" +  $("#fromDate").val()+ "&shiftName=" +  $("#shiftId").val()+"&toDate="+$("#toDate").val();
		...
		var url = "shift_report_report/xls?"+ "fromDate=" +  $("#fromDate").val()+ "&shiftName=" +  $("#shiftId").val()+"&toDate="+$("#toDate").val();
		try { var child = window.open(url); child.focus(); } catch (e) { }
		 });	
		...
		var url = "shift_report_report/csv?"+ "fromDate=" +  $("#fromDate").val()+ "&shiftName=" +  $("#shiftId").val()+"&toDate="+$("#toDate").val();
		try {
