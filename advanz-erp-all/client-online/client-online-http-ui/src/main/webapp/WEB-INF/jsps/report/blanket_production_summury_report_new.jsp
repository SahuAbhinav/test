	...
	$('#toDate').change(function() {
		...
		$("#showreport").click(
			...
			$("#loadingImageHtmlReport").show();
			   ...
			   $.ajax({
				type : "POST",
				url : "blanket_production_sumury_report_new/html?"+ "fromDate=" +  fromDate+ "&runNo="+$("#runNo").val()+"&toDate="+toDate+ "&shiftName=" +  $("#shiftId").val(),
		...
		var url = "blanket_production_sumury_report_new/pdf?"+ "fromDate=" +  fromDate+"&runNo="+$("#runNo").val()+"&toDate="+toDate+ "&shiftName=" +  $("#shiftId").val();
		...
		var url = "blanket_production_sumury_report_new/xls?"+ "fromDate=" +  fromDate+"&runNo="+$("#runNo").val()+"&toDate="+toDate+ "&shiftName=" +  $("#shiftId").val();
		try { var child = window.open(url); child.focus(); } catch (e) { }
		 });	
		...
		var url = "blanket_production_sumury_report_new/csv?"+ "fromDate=" + fromDate+"&runNo="+$("#runNo").val()+"&toDate="+toDate+ "&shiftName=" +  $("#shiftId").val();
		try {
...
<body>
	<div class="header">Blanket Production Summury Report New</div>
	<div class='accordion'>
