	...
	$(document).ready(	function() {
		...
		$("#showreport").click(
			...
			$.ajax({
				...
				type : "POST",
				url : "sales_list_report/html?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemName=" +  $("#itemName").val().replace('&','%26')+ "&partyName=" + $("#partyName").val().replace('&','%26'),
			    success: function(data) {
				   ...
				   return false; 
					...
					$("#downloadPdf").click( function() {
						...
						var url = "sales_list_report/pdf?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemName=" +  $("#itemName").val().replace('&','%26')+ "&partyName=" + $("#partyName").val().replace('&','%26');
					...
					$("#downloadXls").click( function() {
						...
						var url = "sales_list_report/xls?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemName=" +  $("#itemName").val().replace('&','%26')+ "&partyName=" + $("#partyName").val().replace('&','%26');
					 		try { var child = window.open(url); child.focus(); } catch (e) { }
					 });	
	
					$("#downloadCsv").click( function() {
						var url = "sales_list_report/csv?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemName=" +  $("#itemName").val().replace('&','%26')+ "&partyName=" + $("#partyName").val().replace('&','%26');
					 		try {
...
<body>
<div class="header">Sales List Report</div>
<div class='accordion'>
