...
.ic{width:42px !important; border:none !important}
  .in{width:230px !important; border:none !important}
  .pt{width:60px !important; border:none !important}
  .stock{width:70px !important; border:none !important}
  .mil{width:60px !important; border:none !important}
  .br{width:60px !important; border:none !important}
  .mrp{width:60px !important; border:none !important}
  .ld{width:60px !important; border:none !important}
  
  .weight{width:40px !important; border:none !important} 
...
<div class="panel-tool"></div>
		...
		<form:form name="input" id="formID" action="show_item_list_issue" method="post" modelAttribute="searchCriteria">
  ...
  <thead>
   <tr>
						...
						<td style="border: none; " class="ic"><div align="center">	<strong>Item code</strong>	</div>						</td>
						<td style="border: none;" class="in"><div align="center">	<strong>Item name</strong></div>						</td>
						<td  style="border: none;" class="basic"><div align="center">								<strong>UMO</strong>							</div>
			</td>
						<td style="border: none;" class="pt"><div align="center">	<strong>Pack Type</strong></div>				</td>
						<td style="border: none;" class="stock"><div align="center">	<strong>Stock </strong>	</div>			</td>
						
						<td style="border: none;" class="mil"><div align="center">	<strong>MIL </strong>	</div>			</td>
						<td style="border: none;" class="br"><div align="center">	<strong>Basic Rate</strong>	</div>				</td>
						<td style="border: none;" class="mrp"><div align="center">	<strong>M. R. P.</strong>	</div>				</td>
						<td style="border: none;" class="ld"><div align="center">		<strong>Launch Dt.</strong>		</div>					</td>
						<td style="border: none;" class="weight"><div align="center">	<strong>Weight</strong>			</div>				</td>
  ...
  <tbody> 	<c:forEach items="${itemList}" var="item">
						<tr class="sr" style="cursor: pointer;" id="${item.itemId}">
							...
							<td width="60">&nbsp;<c:out value="${item.masterPack.name}"/>							</td>
							<td width="60" 
style="text-align: right;" align="right" >&nbsp;<fmt:formatNumber value="${item.stockTotal}" type="number"  minFractionDigits="2" maxFractionDigits="2"/>&nbsp;</td>
<td width="60" 
style="text-align: right;" align="right" >&nbsp;<fmt:formatNumber value="${item.minStock}" type="number"  minFractionDigits="2" maxFractionDigits="2"/>&nbsp;</td>
							<td width="68" 
style="text-align: right;" align="right">&nbsp;<fmt:formatNumber value="${item.salesRate}" type="number"  minFractionDigits="2" maxFractionDigits="2"/>&nbsp;</td>
							<td width="68" 
style="text-align: right;" align="right">&nbsp;<fmt:formatNumber value="${item.mrp}" type="number"  minFractionDigits="2" maxFractionDigits="2"/>&nbsp;</td>
							<td width="68" >&nbsp;<fmt:formatDate pattern="dd-MMM-yyyy" value="${item.launchDate}" />			
							</td>
							<td width="23" 
style="text-align: right; padding-right: 37px; " align="right">&nbsp;<fmt:formatNumber value="${item.netWeight}" type="number"  minFractionDigits="2" maxFractionDigits="2"/> </td>
  ...
  <div><c:url value="show_item_list_issue" var="item_url">
