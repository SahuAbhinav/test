...
//		alert($('#itemGroupName option:selected').text()); 
		...
		$("#showreport").click(
			...
			$.ajax({
				...
				type : "POST",
				url : "pending_indent_report/html?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemName=" +  $("#itemName").val()+"&pendingStatus="+$("#pendingStatus").val()+"&itemcategory="+$("#itemcategory").val()+"&activeStatus="+$("#activeStatus").val(),
			    success: function(data) {
				   ...
				   return false; 
					...
					$("#downloadPdf").click( function() {
						...
						var url = "pending_indent_report/pdf?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemName=" +  $("#itemName").val()+"&pendingStatus="+$("#pendingStatus").val()+"&itemcategory="+$("#itemcategory").val()+"&activeStatus="+$("#activeStatus").val();
					...
					$("#downloadXls").click( function() {
						...
						var url = "pending_indent_report/xls?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemName=" +  $("#itemName").val()+"&pendingStatus="+$("#pendingStatus").val()+"&itemcategory="+$("#itemcategory").val()+"&activeStatus="+$("#activeStatus").val();
					 		try { var child = window.open(url); child.focus(); } catch (e) { }
					 });	
					...
					$("#downloadCsv").click( function() {
						...
						var url = "pending_indent_report/csv?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemName=" +  $("#itemName").val()+"&pendingStatus="+$("#pendingStatus").val()+"&itemcategory="+$("#itemcategory").val()+"&activeStatus="+$("#activeStatus").val();
					 		try {
