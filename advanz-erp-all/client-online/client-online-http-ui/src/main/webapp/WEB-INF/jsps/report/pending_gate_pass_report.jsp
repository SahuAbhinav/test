...
<script>
	...
	<c:url value="/pending_gate_pass_report/xls" var="downloadXls" />
	<c:url value="/pending_gate_pass_report/pdf" var="downloadPdf" />
	<c:url value="/pending_gate_pass_report/csv" var="downloadCsv" />
...
//		alert($('#itemGroupName option:selected').text()); 
		...
		$("#showreport").click(
			...
			$.ajax({
				...
				type : "POST",
				url : "pending_gate_pass_report/html?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemName=" +  $("#itemName").val()+ "&partyName=" + $("#partyName").val()+"&pendingStatus="+$("#pendingStatus").val()+"&itemcategory="+$("#itemcategory").val()+"&gatePassType="+$("#gatePassType").val()+"&activeStatus="+$("#activeStatus").val(),
			    success: function(data) {
				   ...
				   return false; 
					...
					$("#downloadPdf").click( function() {
						...
						var url = "pending_gate_pass_report/pdf?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemName=" +  $("#itemName").val()+ "&partyName=" + $("#partyName").val()+"&pendingStatus="+$("#pendingStatus").val()+"&itemcategory="+$("#itemcategory").val()+"&gatePassType="+$("#gatePassType").val()+"&activeStatus="+$("#activeStatus").val();
					...
					$("#downloadXls").click( function() {
						...
						var url = "pending_gate_pass_report/xls?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemName=" +  $("#itemName").val()+ "&partyName=" + $("#partyName").val()+"&pendingStatus="+$("#pendingStatus").val()+"&itemcategory="+$("#itemcategory").val()+"&gatePassType="+$("#gatePassType").val()+"&activeStatus="+$("#activeStatus").val();
					 		try { var child = window.open(url); child.focus(); } catch (e) { }
					 });	
					...
					$("#downloadCsv").click( function() {
						...
						var url = "pending_gate_pass_report/csv?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemName=" +  $("#itemName").val()+ "&partyName=" + $("#partyName").val()+"&pendingStatus="+$("#pendingStatus").val()+"&itemcategory="+$("#itemcategory").val()+"&gatePassType="+$("#gatePassType").val()+"&activeStatus="+$("#activeStatus").val();
					 		try {
...
<body>
<div class="header">Pending Gate Pass Report</div>
<div class='accordion'>
...
<div class="headerbg">
	<form:form commandName="salesReportForm" id="formId" name="formName" action="purchase_detail_report" method="GET">
		<table style="width:670px; float: left;">
			<tr>
			...
			<td width="135"><form:select path="partyName" id="partyName" >
			...
			<td width="85">Gate Pass Type</td>
			<td width="145"><select name="gatePassType" id="gatePassType">
