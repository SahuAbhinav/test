	...
	$(document).ready(	function() {
		...
		$("#showreport").click(function() {
			...
			if ($("#fromDate").val() == '') {
			   ...
			   $.ajax({
				type : "POST",
				url : "item_stock_detail_report/html?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemGroupFlagName=" + itemGroupFlagName +"&itemGroupName=" +  groupName + "&name=" + name + "&itemName=" + itemName + "&itemcategory="+itemcategory+"&activeStatus="+$("#activeStatus").val(),
			    success: function(data) {
				   ...
				   return false; 
					...
					$("#downloadPdf").click( function() {
						...
						var url = "item_stock_detail_report/pdf?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemGroupFlagName=" + itemGroupFlagName +"&itemGroupName=" +  groupName + "&name=" + name + "&itemName=" + itemName + "&itemcategory="+itemcategory+"&activeStatus="+$("#activeStatus").val();
					...
					$("#downloadXls").click( function() {
						...
						var url = "item_stock_detail_report/xls?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemGroupFlagName=" + itemGroupFlagName +"&itemGroupName=" +  groupName + "&name=" + name + "&itemName=" +  itemName+ "&itemcategory="+itemcategory+"&activeStatus="+$("#activeStatus").val();
					 		try { var child = window.open(url); child.focus(); } catch (e) { }
					 });	
					...
					$("#downloadCsv").click( function() {
						...
						var url = "item_stock_detail_report/csv?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemGroupFlagName=" +  $("#itemGroupFlagName").val()+"&itemGroupName=" +  $("#itemGroupName").val()+ "&name=" + $("#name").val()+ "&itemName=" +  $("#itemName").val()+"&activeStatus="+$("#activeStatus").val();
					 		try {
...
<body>
<div class="header">Item Wise Stock Detail Report</div>
<div class='accordion'>
...
<div class="headerbg">
		 ...
		 <table style="width: 600px; float:left;">
			...
			<td width="135"><form:select path="itemReportFrom.itemGroupFlagName"  id="itemGroupFlagName"  >
