...
<script type="text/javascript">
	...
	<%//show_invoice %>
	<form:form name="input" action="submitItemListForReturnGetPass" class="formdiv" method="GET" modelAttribute="itemForm">
    <div class="header"> Item List For Return Gate Pass</div> 
...
<form:hidden path="itemDTO.itemId" id="submitItemId"/>
 ...
 <table width="972" class="fixmyheader-8" id="example">
  ...
  <div><c:url value="showItemListForReturnGetPass" var="remove_url">
