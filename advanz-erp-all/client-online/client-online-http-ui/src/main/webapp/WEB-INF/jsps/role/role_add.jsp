...
<form:form id="formID" action="add_role"   method="post" modelAttribute="roleForm"> 
	...
	<div align="left" class="bkgColor"  style="width:973px">
		<table class="" width="405" height="31" border="0" align="center">
			<tr>
				<td width="45" height="24" align="left"><label> Role Name<span style="color: #FF0000">*</span>
				</label></td>
				<td width="150">
				<form:input onkeypress="return check(event)"  type="text" data-maxsize="25"
					class="validate[required] text-input" path="role.roleName" size="20" id="role.roleName" /></td>
				...
				<form:select style="width:113px; height:21px"
							...
							<form:option selected="selected" value="0">Deactivated</form:option>
						</form:select>
				</td>
