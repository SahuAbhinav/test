			...
			function() {
				...
				$("#showreport").click(
						function() {
							...
							$.ajax({
								type : "POST",
								url : "item_category_list_report/html",
				...
				$("#downloadPdf").click(function() {
					var url = "item_category_list_report/pdf";
					try {
				...
				$("#downloadXls").click(function() {
					var url = "item_category_list_report/xls";
					try {
						var child = window.open(url);
						child.focus();
					} catch (e) {
				...
				$("#downloadCsv").click(function() {
					var url = "item_category_list_report/csv";
					try {
						var child = window.open(url);
						child.focus();
					} catch (e) {
...
<body>
<div class="header">Item Category List Report</div>
	<div class='accordion'>
		<h3>
