...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<c:url value="/issue_list_report/xls" var="downloadXls" />
	<c:url value="/issue_list_report/pdf" var="downloadPdf" />
	<c:url value="/issue_list_report/csv" var="downloadCsv" />
		...
		$("#showreport").click(
			...
			$("#loadingImageHtmlReport").show();
			   ...
			   $.ajax({
				...
				type : "POST",
				url : "issue_list_report/html?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemName=" +  $("#itemName").val().replace('&','%26')+"&itemcategory="+$("#itemcategory").val()+"&activeStatus="+$("#activeStatus").val()+"&headName="+$("#headName").val()+"&sectionName="+$("#sectionName").val()+"&rateType="+$("#rateType").val()+"&loanType="+$("#loanType").val(),
			    success: function(data) {
				   ...
				   return false; 
					...
					$("#downloadPdf").click( function() {
						...
						var url = "issue_list_report/pdf?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemName=" +  $("#itemName").val().replace('&','%26')+"&itemcategory="+$("#itemcategory").val()+"&activeStatus="+$("#activeStatus").val()+"&headName="+$("#headName").val()+"&sectionName="+$("#sectionName").val()+"&rateType="+$("#rateType").val()+"&loanType="+$("#loanType").val();
					...
					$("#downloadXls").click( function() {
						...
						var url = "issue_list_report/xls?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemName=" +  $("#itemName").val().replace('&','%26')+"&itemcategory="+$("#itemcategory").val()+"&activeStatus="+$("#activeStatus").val()+"&headName="+$("#headName").val()+"&sectionName="+$("#sectionName").val()+"&rateType="+$("#rateType").val()+"&loanType="+$("#loanType").val();
					 		try { var child = window.open(url); child.focus(); } catch (e) { }
					 });	
					...
					$("#downloadCsv").click( function() {
						...
						var url = "issue_list_report/csv?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemName=" +  $("#itemName").val().replace('&','%26')+"&itemcategory="+$("#itemcategory").val()+"&activeStatus="+$("#activeStatus").val()+"&headName="+$("#headName").val()+"&sectionName="+$("#sectionName").val()+"&rateType="+$("#rateType").val()+"&loanType="+$("#loanType").val();
					 		try {
...
<body>
<div class="header">Issue List Report</div>
<div class='accordion'>
...
<div class="headerbg">
		 ...
		 <table style="width:700px;">
			...
			<td width="100"><input name="fromDate"  id="fromDate" style="width:100pxl;"
							 size="16" readonly="true"/>
							</td>
			<td width="35" nowrap="nowrap">To Date:<span style="color: red;">*</span></td>
			<td width="100"><input name="fromDate"  id="toDate"
							 size="16" readonly="true"/>
							</td>
		...
		<td width="75" >
		<form:select  path="issueReportFrom.itemCategory" id="itemcategory" style="width:120px;" >
				<form:option value="All" selected="selected">All</form:option>
			...
			<td width="250"><form:select path="issueReportFrom.itemName"  id="itemName"  cssStyle="width:150px;" >
				<form:option value="All" selected="selected">All</form:option>
			...
			<td width="135"><select name="loanType" id="loanType">
	...
	<div style="float: right; margin-top: -110px; width: 180px;">
