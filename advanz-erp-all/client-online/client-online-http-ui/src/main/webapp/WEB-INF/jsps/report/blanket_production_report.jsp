...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" isELIgnored="false"%>
	...
	<c:url value="/blanket_production_report/xls" var="downloadXls" />
	<c:url value="/blanket_production_report/pdf" var="downloadPdf" />
	<c:url value="/blanket_production_report/csv" var="downloadCsv" />
	...
	$('#fromDate').change(function() {
		...
		$("#showreport").click(
			...
			$("#loadingImageHtmlReport").show();
			   ...
			   $.ajax({
				type : "POST",
				url : "blanket_production_report/html?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val(),
		...
		var url = "blanket_production_report/pdf?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val();
		...
		var url = "blanket_production_report/xls?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val();
		try { var child = window.open(url); child.focus(); } catch (e) { }
		 });	
		...
		var url = "blanket_production_report/csv?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val();
		try {
...
<body>
	<div class="header">Blanket Production Report</div>
	<div class='accordion'>
