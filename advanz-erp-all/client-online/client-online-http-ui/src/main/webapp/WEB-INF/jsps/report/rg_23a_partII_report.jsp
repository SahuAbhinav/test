...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" isELIgnored="false"%>
	...
	<c:url value="/show_rg23_partII_report/xls" var="downloadXls" />
	<c:url value="/show_rg23_partII_report/pdf" var="downloadPdf" />
	<c:url value="/show_rg23_partII_report/csv" var="downloadCsv" />
...
<script type="text/javascript">
	...
	$(document).ready(	function() {
		...
		$("#showreport").click(
			...
			$("#loadingImageHtmlReport").show();
			   $.ajax({
				type : "POST",
				url : "show_rg23_partII_report/html?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val(),
			    success: function(data) {
				   ...
				   return false; 
					...
					$("#downloadPdf").click( function() {
						...
						var url = "show_rg23_partII_report/pdf?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val();
					...
					$("#downloadXls").click( function() {
						...
						var url = "show_rg23_partII_report/xls?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val();
					 		try { var child = window.open(url); child.focus(); } catch (e) { }
					 });	
					...
					$("#downloadCsv").click( function() {
						...
						var url = "show_rg23_partII_report/csv?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val();
					 		try {
	...
	<body>
		<div class="header">RG 23 A PART-II Report Report</div>
		<div class='accordion'>
	...
	<div style="float: right;    margin-top: -47px;    width: 359px; " >
			<ul class="icon">
