...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<c:url value="/finish_good_list_report/xls" var="downloadXls" />
	<c:url value="/finish_good_list_report/pdf" var="downloadPdf" />
	<c:url value="/finish_good_list_report/csv" var="downloadCsv" />
		...
		$("#showreport").click(
			...
			$("#loadingImageHtmlReport").show();
			   ...
			   $.ajax({
				...
				type : "POST",
				url : "finish_good_list_report/html?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemName=" +  $("#itemName").val().replace('&','%26')+ "&itemcategory=" +  $("#itemcategory").val().replace('&','%26')+"&activeStatus="+$("#activeStatus").val(),
			    success: function(data) {
				   ...
				   return false; 
					...
					$("#downloadPdf").click( function() {
						...
						var url = "finish_good_list_report/pdf?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemName=" +  $("#itemName").val().replace('&','%26')+ "&itemcategory=" +  $("#itemcategory").val().replace('&','%26')+"&activeStatus="+$("#activeStatus").val();
					...
					$("#downloadXls").click( function() {
						...
						var url = "finish_good_list_report/xls?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemName=" +  $("#itemName").val().replace('&','%26')+ "&itemcategory=" +  $("#itemcategory").val().replace('&','%26')+"&activeStatus="+$("#activeStatus").val();
					 		try { var child = window.open(url); child.focus(); } catch (e) { }
					 });	
					...
					$("#downloadCsv").click( function() {
						...
						var url = "finish_good_list_report/csv?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemName=" +  $("#itemName").val().replace('&','%26')+ "&itemcategory=" +  $("#itemcategory").val().replace('&','%26')+"&activeStatus="+$("#activeStatus").val();
					 		try {
...
<body>
<div class="header">Finished Goods List Report</div>
<div class='accordion'>
...
<div class="headerbg">
		 ...
		 <table style="width:600px; float: left;">
			...
			<td width="50"><input name="fromDate"  id="fromDate" style="width:50pxl;"
							 size="16" readonly="true"/>
							</td>
			<td width="35" nowrap="nowrap">To Date:<span style="color: red;">*</span></td>
			<td width="50"><input name="fromDate"  id="toDate"
							 size="16" readonly="true"/>
							</td></tr>
							<tr>
		...
		<form:select  path="partyItemInvoiceReportForm.itemCategory" id="itemcategory" style="width:120px;" >
			...
			<td width="145"><form:select path="partyItemInvoiceReportForm.activeStatus" id="activeStatus">
				<form:option value="All" selected="selected">All</form:option>
