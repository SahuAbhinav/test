			...
			function() {
				...
				$("#showreport").click(
						function() {
							...
							$.ajax({
								type : "POST",
								url : "sales_register_report/html?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&partyName=" + $("#partyName").val().replace('&','%26'),
				...
				$("#downloadPdf").click(function() {
					...
					var url = "sales_register_report/pdf?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&partyName=" + $("#partyName").val().replace('&','%26');
					try {
				...
				$("#downloadXls").click(function() {
					...
					var url = "sales_register_report/xls?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&partyName=" + $("#partyName").val().replace('&','%26');
					try {
						var child = window.open(url);
						child.focus();
					} catch (e) {
				...
				$("#downloadCsv").click(function() {
					...
					var url = "sales_register_report/csv?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&partyName=" + $("#partyName").val().replace('&','%26');
					try {
						var child = window.open(url);
						child.focus();
					} catch (e) {
...
<body>
<div class="header">Sales Register Report</div>
	<div class='accordion'>
		<h3>
