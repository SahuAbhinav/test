...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" isELIgnored="false"%>
	...
	<c:url value="/shift_report_report_new/xls" var="downloadXls" />
	<c:url value="/shift_report_report_new/pdf" var="downloadPdf" />
	<c:url value="/shift_report_report_new/csv" var="downloadCsv" />
	...
	$('#fromDate').change(function() {
		...
		$("#showreport").click(
			...
			$("#loadingImageHtmlReport").show();
			   ...
			   $.ajax({
				type : "POST",
				url : "shift_report_report_new/html?"+ "fromDate=" +  $("#fromDate").val()+ "&shiftName=" +  $("#shiftId").val()+"&toDate="+$("#toDate").val(),
		...
		var url = "shift_report_report_new/pdf?"+ "fromDate=" +  $("#fromDate").val()+ "&shiftName=" +  $("#shiftId").val()+"&toDate="+$("#toDate").val();
		...
		var url = "shift_report_report_new/xls?"+ "fromDate=" +  $("#fromDate").val()+ "&shiftName=" +  $("#shiftId").val()+"&toDate="+$("#toDate").val();
		try { var child = window.open(url); child.focus(); } catch (e) { }
		 });	
		...
		var url = "shift_report_report_new/csv?"+ "fromDate=" +  $("#fromDate").val()+ "&shiftName=" +  $("#shiftId").val()+"&toDate="+$("#toDate").val();
		try {
...
<body>
	<div class="header">Shift Report New</div>
	<div class='accordion'>
...
<div class="headerbg">
		 ...
		 <table style="width: 550px;">
			...
			<td width="135"><input name="toDate" id="toDate"  style="width:50pxl;"
							 size="16" />
							</td>
	...
	<div style="float: right; margin-top:-50px; width: 300px; " >
			<ul class="icon">
