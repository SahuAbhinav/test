...
<script type="text/javascript">
	...
	<form:form name="input" id="formID" action="updateRejectionBlanket_new" modelAttribute="blanketProductionMasterNewForm" >
	<form:hidden path="blanketProductionMasterNewDTO.blanketProductionId" id="sno"/>
		<div class="panel-header" >
			<div class="panel-title">Annealing Rejection Migration New</div>
  ...
  <thead>
   <tr>
				 <td width="32"><div align="center">								<strong>S.No.</strong>							</div>						</td>
						...
						<td width="51"><div align="center">								<strong>Spliter Type</strong>							</div>						</td>
						...
						<td width="51"><div align="center">								<strong>Rej. Roll No.</strong>							</div>						</td>
					...
					<tr id="Lr${s.index}">
						...
						<td width="35" ><form:input path="blanketProductionDetailNewList[${s.index}].length"
							readonly="true" cssStyle="width:100%; "/>
						</td>
						...
						<td width="31" ><form:input path="blanketProductionDetailNewList[${s.index}].rejRollNo"
							 cssStyle="width:100%; "/>
						</td>
						
						
						
						<td width="61" ><form:select path="blanketProductionDetailNewList[${s.index}].status" cssStyle="width:100%; " id="blanketTypeL${s.index}">
						...
						<td width="41" >
						<form:select tabindex="8"  path="blanketProductionDetailNewList[${s.index}].rejItemId" onchange="checkLeftItem(${s.index})"
		           id="itemIdLeft${s.index}"  cssStyle="width:100%; ">
		            ...
		            <td width="31" ><form:input path="blanketProductionDetailNewList[${s.index}].rejRemark"
							 cssStyle="width:100%; "/>
						</td> 
					</tr>
 	</c:forEach>
