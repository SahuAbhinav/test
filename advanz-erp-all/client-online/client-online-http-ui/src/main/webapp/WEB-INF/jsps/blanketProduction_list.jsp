...
<c:if test="${succ=='Blk'}">
	<script type="text/javascript">
		var delUrl = 'get_blanketProduction_list';
		$(document).ready(function() {
...
<form:form name="input" action="get_blanketProduction_list"
	class="formdiv" modelAttribute="bpmSearchCriteria">

	<div class="header">Blanket Production List</div>
	<div class="headingdiv">
		<table width="880" height="31" border="0" cellpadding="0"
			cellspacing="0">
			<tr>
				<td width="45"><a onclick="return checkAdd();"
					href="new_blanketProduction" class="addbtn"></a>
				</td>
...
<td width="64"><form:input path="productionDate" class="datepicker" id="logDate" size="16" readonly="true"/></td> --%>
				...
				<td width="45"><a href="get_blanketProduction_list"
					class="cancelbtn"></a>
				</td>
			</tr>
		</table>
		...
		<table width="972" class="display fixmyheader-8" id="example">
			<thead>
				<tr>
					...
					<td class="TotL" width="80"><div align="center">Tot (L)
							Item</div>
					</td>
					<td class="TotR" width="80"><div align="center">Tot(R)
							Item</div>
					</td>
					<td class="TotL" width="80"><div align="center">Tot (L)
							Wght</div>
					</td>
					<td class="TotR" width="80"><div align="center">Tot
							(R)Wght</div>
					</td>
				...
				<c:forEach items="${bpmList}" var="bpm" varStatus="s">
					<tr>
						<td style="text-align: center;" width="24"><c:url
								value="get_blanketProduction" var="view_url">
						...
						<td width="85" style="text-align: right;">&nbsp;${bpm.blanketProductionDetailLeftDTOList.size()}</td>
						<td width="85" style="text-align: right;">&nbsp;${bpm.blanketProductionDetailRightDTOList.size()}</td>
						<td width="85">&nbsp; <fmt:formatNumber
								value="${bpm.blnktLeftWeight}" type="number"
								minFractionDigits="2" maxFractionDigits="2" /></td>
						<td width="85">&nbsp; <fmt:formatNumber
								value="${bpm.blnktRightWeight}" type="number"
								minFractionDigits="2" maxFractionDigits="2" /></td>
						...
						<c:url
								value="get_blanketProduction" var="remove_url">
								<c:param name="id" value="${bpm.blanketProductionId}"></c:param>
								<c:param name="opr" value="R"></c:param>
							</c:url> 
							
							<c:url value="get_blanketProduction" var="edit_url">
								<c:param name="id" value="${bpm.blanketProductionId}"></c:param>
	...
	<div style="float: right;">
		<c:url value="get_blanketProduction_list" var="remove_url">
