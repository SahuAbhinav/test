...
//		alert($('#itemGroupName option:selected').text()); 
		...
		$("#showreport").click(
			...
			$.ajax({
				...
				type : "POST",
				url : "item_wise_party_sales_report/html?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemName=" +  $("#itemName").val().replace('&','%26')+ "&partyName=" + $("#partyName").val().replace('&','%26')+ "&itemcategory=" + $("#itemcategory").val().replace('&','%26')+"&activeStatus="+$("#activeStatus").val(),
			    success: function(data) {
				   ...
				   return false; 
					...
					$("#downloadPdf").click( function() {
						...
						var url = "item_wise_party_sales_report/pdf?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemName=" +  $("#itemName").val().replace('&','%26')+ "&partyName=" + $("#partyName").val().replace('&','%26')+ "&itemcategory=" + $("#itemcategory").val().replace('&','%26')+"&activeStatus="+$("#activeStatus").val();
					...
					$("#downloadXls").click( function() {
						...
						var url = "item_wise_party_sales_report/xls?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemName=" +  $("#itemName").val().replace('&','%26')+ "&partyName=" + $("#partyName").val().replace('&','%26')+ "&itemcategory=" + $("#itemcategory").val().replace('&','%26')+"&activeStatus="+$("#activeStatus").val();
					 		try { var child = window.open(url); child.focus(); } catch (e) { }
					 });	
					...
					$("#downloadCsv").click( function() {
						...
						var url = "item_wise_party_sales_report/csv?"+ "fromDate=" +  $("#fromDate").val()+ "&toDate=" +  $("#toDate").val()+ "&itemName=" +  $("#itemName").val().replace('&','%26')+ "&partyName=" + $("#partyName").val().replace('&','%26')+ "&itemcategory=" + $("#itemcategory").val().replace('&','%26')+"&activeStatus="+$("#activeStatus").val();
					 		try {
...
<body>
<div class="header">Item Party Wise Sales Report</div>
<div class='accordion'>
...
<div class="headerbg">
		...
		<table style="width:550px; float: left;">
			...
			<td width="135"><form:select path="salesReportForm.partyName" id="partyName" >
		...
		<td width="75" >
		<form:select  path="salesReportForm.itemCategory" id="itemcategory" style="width:120px;" >
				<form:option value="All" selected="selected">All</form:option>
