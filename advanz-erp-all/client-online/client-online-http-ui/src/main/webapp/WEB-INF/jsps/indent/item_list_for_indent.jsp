...
<script>
	$(document).ready(function() {
		$(".cancelbtn").click(function() {
			window.self.location = "backto_indent";
		});
	...
	$(document).ready(function() {		
		...
		$(function() {
			$('.sr').click(function() {
				...
				$.get('get_item_by_idrs', { id: $(this).attr('id')}, function(data) {	
...
.ic{width:42px !important; border:none !important}
  ...
  .weight{width:60px !important; border:none !important} 
		...
		<div class="panel-header">
			<div class="panel-title">Item List for Indent</div>
			<div class="panel-tool"></div>
		</div>
		<div align="left" class="bkgColor" style="height: auto;x">
		<form:form name="input" id="formID" action="show_item_list_indent" method="post" modelAttribute="searchCriteria">
  ...
  <thead>
   <tr>
						...
						<td style="border: none;" class="mil"><div align="center">	<strong>MIL </strong>	</div>	
  ...
  <tbody> 	<c:forEach items="${itemList}" var="item">
						<tr class="sr" style="cursor: pointer;" id="${item.itemId}">
							...
							<td width="50">&nbsp;<c:out value="${item.masterPack.name}"/>							</td>
							<td width="68" 
