...
<script type="text/javascript">
	...
	<form:form name="input" id="formID" action="updateApprovedBlanket"  modelAttribute="blanketProductionMasterForm" >
	<form:hidden path="blanketProductionMasterDTO.blanketProductionId" id="sno"/>
		<div class="panel-header" >
			<div class="panel-title">Approved Blanket Production</div>
  ...
  <thead>
   ...
   <tr>
					...
					<tr id="Lr${s.index}">
						...
						<td width="35" >
						<form:input path="blanketProductionLeftList[${s.index}].lengthLeft"
							readonly="true" cssStyle="width:100%; "/>
						...
						<c:if test="${bpd.rejItemId!=null}" >
						<td width="35" >
						<form:input path="blanketProductionLeftList[${s.index}].rejLengthl"
							readonly="true" cssStyle="width:100%; "/>
							
						</td>
						<td width="34"><form:input path="blanketProductionLeftList[${s.index}].rejWidthl"
							readonly="true" cssStyle="width:100%; "/>
						</td>
						<td width="32" ><form:input path="blanketProductionLeftList[${s.index}].rejThickl"
							readonly="true" cssStyle="width:100%; "/>
						</td>
						<td width="37" ><form:input path="blanketProductionLeftList[${s.index}].rejWeightl"
							readonly="true" cssStyle="width:100%; "/>
							
						</td>
						<td width="31" ><form:input path="blanketProductionLeftList[${s.index}].rejDensityl"
							readonly="true" cssStyle="width:100%; "/>
						</td> 
						...
						<td width="31" ><form:input path="blanketProductionLeftList[${s.index}].blanketType"
						 ...
						 <td width="31" ><form:input path="blanketProductionLeftList[${s.index}].creationDate"
							readonly="true" cssStyle="width:100%; "/>
						</td>
						<td width="61" >
						<form:input path="blanketProductionLeftList[${s.index}].statusLeft"
							readonly="true" cssStyle="width:100%; "/>
						</td><td width="61" >
						<form:checkbox class="checkbox1" path="blanketProductionLeftList[${s.index}].approvedStatus" value="1" />
						</td>
						<td width="61" >
						<form:checkbox class="checkbox2" path="blanketProductionLeftList[${s.index}].checkRejection" value="1" />
						</td>
  ...
  <tbody>
					...
					<table width="668"   class="fixmyheader"  class="fixmyheader-8" >
					   ...
					   <tr> 
						...
						<td width="58"><div align="center">								<strong>Created Date</strong>							</div>						</td>
						<td width="55"><div align="center">								<strong>Status</strong>							</div>						</td>
						<td width="55"><div align="center">								<strong>Approved</strong>							</div>						</td>
						<td width="55"><div align="center">								<strong>Reject</strong>							</div>						</td>
					</tr>
					</thead>
				    <tbody >
					...
					<tr id="Rr${s.index}">
						...
						<td width="35" ><form:input path="blanketProductionRightList[${s.index}].rejLengthr"
							readonly="true" cssStyle="width:100%; "/>
						</td>
						<td width="34"><form:input path="blanketProductionRightList[${s.index}].rejWidthr"
							readonly="true" cssStyle="width:100%; "/>
						</td>
						<td width="32" ><form:input path="blanketProductionRightList[${s.index}].rejThickr"
							readonly="true" cssStyle="width:100%; "/>
						</td>
						<td width="37" ><form:input path="blanketProductionRightList[${s.index}].rejWeightr"
							readonly="true" cssStyle="width:100%; "/>
							
						</td>
						<td width="31" ><form:input path="blanketProductionRightList[${s.index}].rejDensityr"
							readonly="true" cssStyle="width:100%; "/>
						</td> 
						</c:if>
						...
						<td width="31" ><form:input path="blanketProductionRightList[${s.index}].creationDate"
							readonly="true" cssStyle="width:100%; "/>
						</td> 
						<td width="61" ><form:input path="blanketProductionRightList[${s.index}].statusRight" cssStyle="width:100%; " readonly="true" id="blanketTypeL${s.index}" />
						</td>
						<td width="61" >
						<form:checkbox class="checkbox1" path="blanketProductionRightList[${s.index}].approvedStatus"  value="1" />
						</td>
						
						<td width="61" >
						<form:checkbox class="checkbox2" path="blanketProductionRightList[${s.index}].checkRejection"  value="1" />
						</td>
					</tr>
					</c:forEach>
					<tbody>
