 ...
 */
@Controller
public class ZoneListReportController {

	protected static Logger logger = Logger
			.getLogger(ZoneListReportController.class);
	@Autowired
	 ...
	 */
	@RequestMapping(value = "/zone_list_report", method = RequestMethod.GET)
	 ...
	 * @return
	 */
	@RequestMapping(value = "/zone_list_report/xls", method = RequestMethod.GET)
	public ModelAndView doSalesReportXLS(ModelAndView modelAndView,
		...
		response.setHeader("filename", "zone_list_report.xls");
		...
		modelAndView = new ModelAndView("xlsZone", parameterMap);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/zone_list_report/pdf", method = RequestMethod.GET)
	public ModelAndView doSalesReportPDF(ModelAndView modelAndView,
			HttpServletResponse response, HttpServletRequest request) {
		logger.debug("Received request to download PDF report");
		// response.setHeader("Content-Disposition","attachment");
		response.setHeader("filename", "zone_list_report.pdf");
		...
		modelAndView = new ModelAndView("pdfZone", parameterMap);
		// Return the View and the Model combined
		return modelAndView;
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/zone_list_report/csv", method = RequestMethod.GET)
	public ModelAndView doSalesReportCSV(ModelAndView modelAndView,
			HttpServletResponse response) {
		logger.debug("Received request to download CSV report");
		// response.setHeader("Content-Disposition","attachment");
		response.setHeader("filename", "zone_list_report.csv");
		...
		// pdfReport is the View of our application
		// This is declared inside the /WEB-INF/jasper-views.xml
		modelAndView = new ModelAndView("csvZone", parameterMap);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/zone_list_report/html", method = RequestMethod.POST)
	public @ResponseBody
