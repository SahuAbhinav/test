 ...
 */
@Controller
public class StoreLocationListReportController {

	protected static Logger logger = Logger
			.getLogger(StoreLocationListReportController.class);
	@Autowired
	 ...
	 */
	@RequestMapping(value = "/store_location_list_report", method = RequestMethod.GET)
	public String getDownloadPage(Model model) {
		...
		ArrayList<StoreLocationDTO> storelocationList = (ArrayList<StoreLocationDTO>) storelocationOutMessage.getStoreLocationDTOList();

		// ModelAndView mav = new ModelAndView();
		// mav.addObject("billList",billList);
		model.addAttribute("storelocationList", storelocationList);
		return "store_location_list_report_view";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/store_location_list_report/xls", method = RequestMethod.GET)
	public ModelAndView doSalesReportXLS(ModelAndView modelAndView,
		...
		response.setHeader("filename", "store_location_list_report.xls");
		...
		modelAndView = new ModelAndView("xlsStoreLocation", parameterMap);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/store_location_list_report/pdf", method = RequestMethod.GET)
	public ModelAndView doSalesReportPDF(ModelAndView modelAndView,
			HttpServletResponse response, HttpServletRequest request) {
		logger.debug("Received request to download PDF report");
		// response.setHeader("Content-Disposition","attachment");
		response.setHeader("filename", "store_location_list_report.pdf");
		...
		modelAndView = new ModelAndView("pdfStoreLocation", parameterMap);
		// Return the View and the Model combined
		return modelAndView;
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/store_location_list_report/csv", method = RequestMethod.GET)
	public ModelAndView doSalesReportCSV(ModelAndView modelAndView,
			HttpServletResponse response) {
		logger.debug("Received request to download CSV report");
		// response.setHeader("Content-Disposition","attachment");
		response.setHeader("filename", "store_location_list_report.csv");
		...
		// pdfReport is the View of our application
		// This is declared inside the /WEB-INF/jasper-views.xml
		modelAndView = new ModelAndView("csvStoreLocation", parameterMap);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/store_location_list_report/html", method = RequestMethod.POST)
	public @ResponseBody
	Map showHTMLReport(ModelAndView modelAndView) {
		...
		try {
			...
			InputStream reportStream = this.getClass().getResourceAsStream(
					"/reports/Store_Location_List.jasper");
