 ...
 */
@Controller
public class CountryListReportController {

	protected static Logger logger = Logger
			.getLogger(CountryListReportController.class);
	@Autowired
	 ...
	 */
	@RequestMapping(value = "/country_list_report", method = RequestMethod.GET)
	public String getDownloadPage(Model model) {
		logger.debug("Received request to show download page");

		CountryOutMessage countryOutMessage = countryService.findAllCountrys();

		ArrayList<CountryDTO> countryList = (ArrayList<CountryDTO>) countryOutMessage.getCountryDTOList();

		// ModelAndView mav = new ModelAndView();
		// mav.addObject("billList",billList);
		model.addAttribute("countryList", countryList);
		return "country_list_report_view";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/country_list_report/xls", method = RequestMethod.GET)
	public ModelAndView doSalesReportXLS(ModelAndView modelAndView,
		...
		response.setHeader("filename", "country_list_report.xls");
		...
		modelAndView = new ModelAndView("xlsCountry", parameterMap);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/country_list_report/pdf", method = RequestMethod.GET)
	public ModelAndView doSalesReportPDF(ModelAndView modelAndView,
			HttpServletResponse response, HttpServletRequest request) {
		logger.debug("Received request to download PDF report");
		// response.setHeader("Content-Disposition","attachment");
		response.setHeader("filename", "country_list_report.pdf");
		...
		modelAndView = new ModelAndView("pdfCountry", parameterMap);
		// Return the View and the Model combined
		return modelAndView;
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/country_list_report/csv", method = RequestMethod.GET)
	public ModelAndView doSalesReportCSV(ModelAndView modelAndView,
			HttpServletResponse response) {
		logger.debug("Received request to download CSV report");
		// response.setHeader("Content-Disposition","attachment");
		response.setHeader("filename", "country_list_report.csv");
		...
		// pdfReport is the View of our application
		// This is declared inside the /WEB-INF/jasper-views.xml
		modelAndView = new ModelAndView("csvCountry", parameterMap);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/country_list_report/html", method = RequestMethod.POST)
	public @ResponseBody
