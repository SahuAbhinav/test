 ...
 */
@Controller
public class RegionListReportController {
	 ...
	 */
	@RequestMapping(value = "/region_list_report", method = RequestMethod.GET)
	public String getDownloadPage(Model model) {
		...
		RegionReportFrom regionReportFrom = new RegionReportFrom(); 
		
		// ModelAndView mav = new ModelAndView();
		// mav.addObject("billList",billList);
		
		model.addAttribute("regionReportFrom", regionReportFrom);
		...
		return "region_list_report_view";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/region_list_report/xls", method = RequestMethod.GET)
	public ModelAndView doSalesReportXLS(ModelAndView modelAndView,
			@RequestParam("ZoneNamePrompt") String ZoneNamePrompt,@RequestParam("StateNamePrompt") String StateNamePrompt, 
			HttpServletResponse response) {
		logger.debug("Received request to download Excel report");
		// response.setHeader("Content-Disposition","attachment");
		response.setHeader("filename", "region_list_report.xls");
		...
		modelAndView = new ModelAndView("xlsRegion", parameterMap);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/region_list_report/pdf", method = RequestMethod.GET)
	public ModelAndView doSalesReportPDF(ModelAndView modelAndView,
			@RequestParam("ZoneNamePrompt") String ZoneNamePrompt,@RequestParam("StateNamePrompt") String StateNamePrompt,
			HttpServletResponse response, HttpServletRequest request) {
		logger.debug("Received request to download PDF report");
		// response.setHeader("Content-Disposition","attachment");
		response.setHeader("filename", "region_list_report.pdf");
		...
		modelAndView = new ModelAndView("pdfRegion", parameterMap);
		// Return the View and the Model combined
		return modelAndView;
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/region_list_report/csv", method = RequestMethod.GET)
	public ModelAndView doSalesReportCSV(ModelAndView modelAndView,
			@RequestParam("ZoneNamePrompt") String ZoneNamePrompt,@RequestParam("StateNamePrompt") String StateNamePrompt,
			HttpServletResponse response) {
		logger.debug("Received request to download CSV report");
		// response.setHeader("Content-Disposition","attachment");
		response.setHeader("filename", "region_list_report.csv");
		...
		// pdfReport is the View of our application
		// This is declared inside the /WEB-INF/jasper-views.xml
		modelAndView = new ModelAndView("csvRegion", parameterMap);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/region_list_report/html", method = RequestMethod.POST)
	public @ResponseBody
