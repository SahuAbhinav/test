...
@Controller
public class SalaryCalReportController {
	protected static Logger logger = Logger
			.getLogger(SalaryCalReportController.class);
	@Autowired
	DataSource dataSource;
	
	@RequestMapping(value = "/salary_report", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/salary_report/xls", method = RequestMethod.GET)
	public ModelAndView getSalaryXls(ModelAndView modelAndView,
			...
			HttpServletResponse response)
	{
		...
		response.setHeader("filename", "Salary_Calculation.xls");
		...
		modelAndView = new ModelAndView("xlsSalaryCal", parameterMap);
	...
	@RequestMapping(value = "/salary_report/pdf", method = RequestMethod.GET)
	public ModelAndView doSalesReportPDF(ModelAndView modelAndView,
			@RequestParam("monthName") String monthName,@RequestParam("yearName") String yearName,
			HttpServletResponse response, HttpServletRequest request) {
		logger.debug("Received request to download PDF report");
		// response.setHeader("Content-Disposition","attachment");
		response.setHeader("filename", "Salary_Calculation.pdf");
		...
		modelAndView = new ModelAndView("pdfSalaryCal", parameterMap);
		// Return the View and the Model combined
		return modelAndView;
	}
	
	
	@RequestMapping(value = "/salary_report/csv", method = RequestMethod.GET)
	public ModelAndView doSalesReportCSV(ModelAndView modelAndView,HttpServletResponse response,
		...
		// response.setHeader("Content-Disposition","attachment");
		response.setHeader("filename", "Salary_Calculation.csv");
		...
		// pdfReport is the View of our application
		// This is declared inside the /WEB-INF/jasper-views.xml
		modelAndView = new ModelAndView("csvSalaryCal", parameterMap);

		// Return the View and the Model combined
		return modelAndView;
	}
	
	@RequestMapping(value = "/salary_report/html", method = RequestMethod.POST)
	public @ResponseBody
	Map showHTMLReport(ModelAndView modelAndView,
		...
		try {
			...
			InputStream reportStream = this.getClass().getResourceAsStream(
					"/reports/sallary_summary_new.jasper");
