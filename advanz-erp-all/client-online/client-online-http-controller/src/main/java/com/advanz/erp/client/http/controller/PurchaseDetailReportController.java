...
public class PurchaseDetailReportController {
	...
	protected static Logger logger = Logger
			.getLogger(PurchaseDetailReportController.class);
	@Autowired
	...
	@RequestMapping(value = "/purchase_detail_report", method = RequestMethod.GET)
	public String getDownloadPage(Model model,@ModelAttribute("purchaseReportFrom") PurchaseReportFrom purchaseReportFrom) {
	   ...
	   // PurchaseReportFrom purchaseReportFrom = new PurchaseReportFrom();
	   // purchaseReportFrom.setToDate(new Date());
		model.addAttribute("purchaseReportFrom", purchaseReportFrom);
		model.addAttribute("itemGroupList",itemGroupList);
		model.addAttribute("masterList",masterList);
	return "purchase_detail_report_view";
	}
	...
	@RequestMapping(value = "/purchase_detail_report/xls", method = RequestMethod.GET)
	public ModelAndView doSalesReportXLS(ModelAndView modelAndView,@RequestParam("fromDate") Date fromDate,@RequestParam("toDate") Date toDate,@RequestParam("itemGroupFlagName") String itemGroupFlagName,@RequestParam("name") String name,
			HttpServletResponse response) {
		logger.debug("Received request to download Excel report");
		
		response.setHeader("filename", "purchase_detail_report.xls");
		...
		modelAndView = new ModelAndView("xlsPurchaseDetail", parameterMap);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/purchase_detail_report/pdf", method = RequestMethod.GET)
	public ModelAndView doSalesReportPDF(ModelAndView modelAndView,@RequestParam("fromDate") Date fromDate,@RequestParam("toDate") Date toDate,@RequestParam("itemGroupFlagName") String itemGroupFlagName,@RequestParam("name") String name,
			HttpServletResponse response, HttpServletRequest request) {
		logger.debug("Received request to download PDF report");
		// response.setHeader("Content-Disposition","attachment");
		response.setHeader("filename", "purchase_detail_report.pdf");
		...
		modelAndView = new ModelAndView("pdfPurchaseDetail", parameterMap);
		// Return the View and the Model combined
		return modelAndView;
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/purchase_detail_report/csv", method = RequestMethod.GET)
	public ModelAndView doSalesReportCSV(ModelAndView modelAndView,@RequestParam("fromDate") Date fromDate,@RequestParam("toDate") Date toDate,@RequestParam("itemGroupFlagName") String itemGroupFlagName,@RequestParam("name") String name,
			HttpServletResponse response) {
		logger.debug("Received request to download CSV report");
		// response.setHeader("Content-Disposition","attachment");
		response.setHeader("filename", "purchase_detail_report.csv");
		...
		// pdfReport is the View of our application
		// This is declared inside the /WEB-INF/jasper-views.xml
		modelAndView = new ModelAndView("csvPurchaseDetail", parameterMap);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/purchase_detail_report/html", method = RequestMethod.POST)
	public @ResponseBody
	Map showHTMLReport(ModelAndView modelAndView,@RequestParam("fromDate") Date fromDate,@RequestParam("toDate") Date toDate,@RequestParam("itemGroupFlagName") String itemGroupFlagName,@RequestParam("name") String name) {
		...
		try {
			...
			InputStream reportStream = this.getClass().getResourceAsStream(
					"/reports/Purchase_Detail_Report.jasper");
