...
public class BillEntity extends BaseEntity {
	...
	/*
	 * @Column(name = "branch_id") public Integer getBranchId() { return
	 * branchId; }
	 * 
	...
	/*
	 * @Column(name = "party_id") public Integer getPartyId() { return partyId;
	 * }
	 * 
	...
	/*
	 * @Column(name = "employee_id") public Integer getEmployeeId() { return
	 * employeeId; }
	 * 
	 * public void setEmployeeId(Integer employeeId) { this.employeeId =
	 * employeeId; }
	 */
